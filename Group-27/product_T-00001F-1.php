...
$description = "The Victor T-00001F-1 shirt is crafted for optimal performance on the court. Made with moisture-wicking fabric, it keeps you cool and dry during intense matches.";
$specifications = [
    "Material: Polyester",
    "Color: Red/Black",
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($name); ?> - Product Victor T-00001F-1</title>
...
<body onload="checkStock(<?php echo $store; ?>)">
    ...
    <main>
        <div class="product-detail">
            <img src="T-00001F-1.jpg" alt="<?php echo htmlspecialchars($name); ?>">
            <div class="product-info">
                ...
                <div class="purchase-section">
                    ...
                    <button <?php echo ($store == 0) ? 'disabled' : ''; ?> onclick="addToCart('<?php echo htmlspecialchars($name); ?>', <?php echo htmlspecialchars($price); ?>, 'T-00001F-1.jpg', document.getElementById('shirt-size').value)">
                        Add to Cart
                    </button>
                </div>
            </div>
