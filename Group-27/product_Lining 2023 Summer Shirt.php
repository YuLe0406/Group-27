...
$description = "The Lining 2023 Summer Shirt is perfect for hot weather, made from breathable material that keeps you cool and comfortable during intense matches.";
$specifications = [
    "Material: Polyester",
    "Color: Yellow",
...
<body>
    ...
    <main>
        <div class="product-detail">
            <img src="Lining 2023 summer shirt.png" alt="<?php echo htmlspecialchars($name); ?>">
            <div class="product-info">
                ...
                <div class="purchase-section">
                    ...
                    <button <?php echo ($store == 0) ? 'disabled' : ''; ?> onclick="addToCart('<?php echo htmlspecialchars($name); ?>', <?php echo htmlspecialchars($price); ?>, 'Lining 2023 summer shirt.png', document.getElementById('shirt-size').value)">
                        Add to Cart
                    </button>
                </div>
            </div>
