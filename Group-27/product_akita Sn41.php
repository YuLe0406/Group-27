...
$description = "The Yonex Akita Sn41 shoes are designed for athletes seeking lightweight and comfortable footwear. These shoes provide excellent support and stability, perfect for competitive play.";
$specifications = [
    "Weight: 260g",
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($name); ?> - Product Yonex Akita Sn41</title>
...
<body onload="checkStock(<?php echo $store; ?>)">
    ...
    <main>
        <div class="product-detail">
            <img src="yonex_akita_sn41.jpg" alt="<?php echo htmlspecialchars($name); ?>">
            <div class="product-info">
                ...
                <div class="purchase-section">
                    ...
                    <button <?php echo ($store == 0) ? 'disabled' : ''; ?> onclick="addToCart('<?php echo htmlspecialchars($name); ?>', <?php echo htmlspecialchars($price); ?>, 'yonex_akita_sn41.jpg', document.getElementById('shoe-size').value)">
                        Add to Cart
                    </button>
                </div>
            </div>
